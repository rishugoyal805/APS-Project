...
bool deleteExpenses(string &filename, string &date){
    int month, day;
    try{month = stoi(date.substr(5, 2)) - 1;
        day = stoi(date.substr(8, 2)) - 1;
        if (month < 0 || month >= 12 || day < 0 || day >= 31){
...
{   int totalSpent = 0;
    ...
    cout << " Available for Loan Repayment: Rs." << availableFunds << endl<< endl;
        ...
        try{cout << "\nExpense Tracker Menu:";
            ...
            case 9:{
                ...
                while (true){
                    ...
                    if (isValidIntInput(goal) && goal > 0) break;
                ...
                while (true){
                    ...
                    if (isValidIntInput(excessAmount)) break;
            ...
            case 10:{
                ...
                while (true){
                    ...
                    if (isValidIntInput(funds)) break;
